/**
 * WorkflowSection - Enhanced with micro-animations
 */
          ...
          {workflowSteps.map((step, index) => (
            ...
            >
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <motion.p
                  className="text-foreground font-medium text-caption max-w-[160px]"
        ...
        <div className="md:hidden space-y-4">
          {workflowSteps.map((step, index) => (
            <motion.div
              ...
              className="flex items-center gap-4 p-3 rounded-xl active:bg-muted/50 transition-colors"
            >
              <motion.div
