...
const FloatingCard = ({
  ...
  return (
    <motion.div style={{ x, y, rotate: rotation }} className={`absolute ${className}`}>
      {children}
    </motion.div>
  );
};
...
export const CreativeHeroSection = () => {
  ...
  return (
    ...
    >
      ...
      {/* Sparkles */}
      <FloatingCard mouseX={springX} mouseY={springY} depth={2} className="top-[30%] left-[25%] text-white/20">
        <Sparkle className="w-6 h-6" />
      </FloatingCard>

      <FloatingCard mouseX={springX} mouseY={springY} depth={2.5} className="top-[60%] right-[25%] text-white/15">
        <Sparkle className="w-5 h-5" />
      </FloatingCard>

      <FloatingCard mouseX={springX} mouseY={springY} depth={1.8} className="bottom-[35%] left-[35%] text-white/10">
